...
# ... rest of your code
    ...
    for i, (file, audio, audio_sr) in enumerate(loader):
        ...
        output_file_name = os.path.splitext(fn)[0] + '_enhancedd.wav'
        output_audio_file = os.path.join(args.output_dir, output_file_name)
        torchaudio.save(output_audio_file, audio, sample_rate=audio_sr)
