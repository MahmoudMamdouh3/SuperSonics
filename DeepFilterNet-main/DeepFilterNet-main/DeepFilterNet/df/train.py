...
from df.evaluation_utils import *
...
def main():
    ...
    parser.add_argument(
     "--data_config_file", 
     default="DeepFilterNet-main/DeepFilterNet/noisyspeech_synthesizer.cfg", type=str, 
     help="Path to a dataset config file.")
    parser.add_argument(
        "--data_dir",
        type=str, default="D:/Grad/DeepFilterNet/DeepFilterNet-main/DeepFilterNet-main/DeepFilterNet/df/newDS/", 
        help="Path to the dataset directory containing .hdf5 files."
    )
    parser.add_argument(
        "--base_dir", 
        type=str, default="D:/Grad/DeepFilterNet/DeepFilterNet-main/DeepFilterNet-main/DeepFilterNet/try", 
    ...
    signal.signal(signal.SIGINT, get_sigusr1_handler(args.base_dir))
